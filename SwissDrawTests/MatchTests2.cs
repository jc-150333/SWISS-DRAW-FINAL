...
namespace SwissDraw.Tests
{
    ...
    public class MatchTests2
    {
        ...
        public void MakeMatchTest1()
        {
            ...
            persons.Add(3, new Person { LotNumber = 3, PersonGroup = "A", PersonName = "う" });
            persons.Add(4, new Person { LotNumber = 4, PersonGroup = "B", PersonName = "え" });
            persons.Add(5, new Person { LotNumber = 5, PersonGroup = "B", PersonName = "お" });
            ...
            Assert.AreEqual(2, matches2[1].Person2);
            ...
            Match[] matchematche = Match.MergeMatch(matches, matches2);

            Match[] matches3 = Match.MakeMatch(persons, matchematche);
            ...
            Assert.AreEqual(6, matches3[1].Person2);
            Assert.AreEqual(2, matches3[2].Person1);
            Assert.AreEqual(4, matches3[2].Person2);
            matches3[0].Result = 2;
            matches3[1].Result = 2;
            matches3[2].Result = 1;
            //Assert.AreEqual(1, matches2[0].Person1);
        ...
        public void isSameGroupTest3()
        {
            ...
            persons.Add(5, new Person { LotNumber = 5, PersonGroup = "B", PersonName = "尾堂" });
            persons.Add(6, new Person { LotNumber = 6, PersonGroup = "C", PersonName = "加藤" });
            var result = Match.isSameGroup(persons, 1, 3);
            Assert.AreEqual(true, Match.isSameGroup(persons, 1, 3));
            Assert.AreEqual(false, Match.isSameGroup(persons, 4, 6));
        }
